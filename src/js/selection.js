        ...
        if (Phaser.Input.Keyboard.JustDown(this.enterKey)) {
            for (const porte of groupe_portes.children.entries) {
                ...
                if (distance < 100 && porte.estSolide) {
                    ...
                    else if (porte.doorName === "door31")                        { destination = "map_stuff";     porteDestination = "door_retour2"; }
                    else if (porte.doorName === "door4")                         { destination = "map_monstre";   porteDestination = "door_monstre"; }
